...
EOF)
    ...
    ITUNES_ARRAY=($ITUNES_TRACK)
    CLIPPPED_TRACK=${ITUNES_ARRAY[0]}" "${ITUNES_ARRAY[1]}"..."
    echo '#[fg=white,bg=magenta]' $ITUNES_ARTIST '#[nobold]-#[bold]' $CLIPPPED_TRACK '#[fg=white,bg=blue,nobold]'
fi
