...
# Each project I work on has a corresponding tmuxinator project
...
# If the name is the same as the name of a project (tmuxinator), it loads variables/settings defined for that project 
...
total-immersion-podcast)
  echoGreen "  TOTAL IMMERSION PROJECT LOADED"
  ;;
welkin)
  export GITHUB_HOSTNAME="https://github.com/welkinhealth/welkin"
  echoGreen "  WELKIN PROJECT LOADED"
  ;;
*)
  echoYellow "  NO PROJECT LOADED"
  ;;
esac
