...
tmux new-window -t $2:1 -n Graphql
...
tmux send-keys -t $2:2 "nvm use 8.9.4" C-m C-m
tmux send-keys -t $2:2 "npm start" C-m C-m

tmux send-keys -t $2:3 "cd $1" C-m C-m
tmux send-keys -t $2:3 "cd $2/src" C-m C-m
tmux send-keys -t $2:3 "vim" C-m C-m

tmux send-keys -t $2:4 "cd $1" C-m C-m
tmux send-keys -t $2:4 "cd $2" C-m C-m
