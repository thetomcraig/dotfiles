...
then
  ...
  displayplacer "id:35120216-2552-4D1B-A398-C1EC8C9A4D7D res:2560x1440 hz:60 color_depth:8 enabled:true scaling:on origin:(0,0) degree:0" "id:37D8832A-2D66-02CA-B9F7-8F30A301B230 res:1728x1117 hz:120 color_depth:8 enabled:true scaling:on origin:(2560,0) degree:0" "id:DB3CA055-0148-492C-A78B-B37C5307CC18 res:1440x2560 hz:60 color_depth:8 enabled:true scaling:off origin:(-1440,-741) degree:90"
  displayplacer "id:35120216-2552-4D1B-A398-C1EC8C9A4D7D res:2560x1440 hz:60 color_depth:8 enabled:true scaling:on origin:(0,0) degree:0" "id:37D8832A-2D66-02CA-B9F7-8F30A301B230 res:1728x1117 hz:120 color_depth:8 enabled:true scaling:on origin:(2560,0) degree:0" "id:DB3CA055-0148-492C-A78B-B37C5307CC18 res:1440x2560 hz:60 color_depth:8 enabled:true scaling:off origin:(-1440,-741) degree:90"
fi
