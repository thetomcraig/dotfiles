...
if [ "${num_displays}" = "4" ]; then
  # Dell 27
  /usr/local/bin/desktoppr 0 "/Users/tomcraig/Dropbox/TomCraig/07 Pictures/Wallpapers/wave_1.png"
  # Internal
  /usr/local/bin/desktoppr 1 "/Users/tomcraig/Dropbox/TomCraig/07 Pictures/Wallpapers/wave_2_no_notch.png"
  # Dell 25
